"""
Django settings for gif_videos project.
...
SECRET_KEY = "django-insecure-e5l$1l5%eb(x09p1(o4z62i9kk-w=8%g$52d6=_*j4zba^g72_"
...
WSGI_APPLICATION = "gif_videos.wsgi.application"
...
CELERY_BEAT_SCHEDULE = {
    'purge-stale-uploads': {
        'task':     'myapp.tasks.purge_stale_uploads',
